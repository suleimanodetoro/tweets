<div class="card">
    <div class="px-3 pt-4 pb-2">
        <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="card-title mb-0"><a href="#"> Suleiman</a></h5>
                </div>
            </div>
            <div>
    ...
    <div class="card-body">
        ...
        @else
        <p class="d-flex justify-content-between">{{$idea->content}}</p>
        ...
        <div>
            ...
            <div class="d-flex align-items-start">
                ...
                <div class="w-100">
                    ...
                    <p class="fs-6 mt-3 fw-light">and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance.</p>
                </div>
            </div>
        </div>
    </div>
